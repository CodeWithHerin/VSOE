            ...
            >
                ...
                <div className={cn(
                    ...
                    <Link href="/" className={cn(
                        ...
                        <div className="font-display text-base sm:text-lg md:text-2xl font-bold text-white tracking-wider group-hover:text-vsoe-gold transition-colors duration-500 whitespace-nowrap">
                            <span className="hidden sm:inline">PROJECT </span>VITESSE
                        </div>
