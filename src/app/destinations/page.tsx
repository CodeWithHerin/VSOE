...
export default function DestinationsPage() {
    return (
        <main className="min-h-screen bg-vsoe-midnight text-vsoe-cream">
            ...
            <HeroSection
                title="Destinations"
                subtitle="Europe's Most Captivating Cities"
                        ...
                        >
                            ...
                            <div className="aspect-[4/3] overflow-hidden relative">
                                ...
                                <div className="absolute top-4 right-4 bg-vsoe-midnight/90 px-3 py-1 border border-vsoe-gold/50">
                                    <span className="text-xs tracking-widest uppercase text-vsoe-gold">{journey.duration}</span>
                                </div>
                            </div>

                            {/* Content */}
                            <div className="p-8">
                                <h3 className="text-2xl font-serif text-vsoe-cream mb-2">{journey.name}</h3>
